# Version 6-new-def of Algo
# New defense configuration implemented based on v6
...
To upload to terminal, upload the entire v6-new-def folder.
...
New defense configuration implemented. 
