...
To upload to terminal, upload the entire v6 folder.
...
Start with a 'basic-v2' defensive configuration with mild scout attacks. Once accumulated enough SP (threshold 90), switch to a new offense configuration. 
The new offense configuration is a plainly attacking configuration. Switch back to basic-v2 configuration after attacking. 

mp threshold 12+bonus*3
