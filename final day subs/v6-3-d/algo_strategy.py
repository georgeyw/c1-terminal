...
class AlgoStrategy(gamelib.AlgoCore):
    def __init__(self):
        ...
        self.basic_config_orientation = 'normal'
    ...
    def initial_strategy_new_offense(self, game_state):
        ...
        if self.mode == 'basic' and self.offense == 'off':
            if self.basic_config_orientation == 'normal':
                self.maintain_defense_v2(game_state, ul.basic_v2_new_build_order)
            else:
                self.maintain_defense_v2(game_state, ul.basic_v2_new_build_order_reversed)
        ...
        if game_state.turn_number == 1:
            ...
            if random.random() < 0.5:
                ...
                self.basic_config_orientation = 'reversed'
