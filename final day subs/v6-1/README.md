...
To upload to terminal, upload the entire v6-1 folder.
...
This is the combination of basic v2 defense, v2 offense (plain defense with many support), with mp threshold 10+bonus*3.
