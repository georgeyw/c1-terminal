# Version 6-5 of Algo - Also final submitted version
# Updated from also v6-4
...
To upload to terminal, upload the entire v6-5 folder.
...
This is new defense and new offense (plain defense with many support)+ interceptor defender with mp threshold 12+bonus*3.
