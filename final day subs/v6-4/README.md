# Version 6-4 of Algo - Also final submitted version
...
To upload to terminal, upload the entire v6-4 folder.
...
This is new defense and new offense (plain defense with many support) with mp threshold 12+bonus*3.
